<%-- 
    Document   : InnerMaster
    Created on : Jun 20, 2014, 10:12:38 PM
    Author     : Dpm
--%>
  ...
  <div class="row-top">
    <div class="main">
      <div class="wrapper">
        ...
        <nav>
          <ul class="menu">
              <li><a class="active" href="InnerPages/EmployeeList.jsp">Employees</a></li>
              <li><a href="InnerPages/EmployeeAvailability.jsp">Employee Availability</a></li>
