<%-- 
    Document   : Masters
    Created on : Jun 28, 2014, 2:21:30 PM
    Author     : Pushpraj
--%>
    ...
    <div class="row-bot-bg">
      <div class="main">
       ...
       <form method="Get" action="Masters">
        ...
        <div style="margin-left: 10%">
        <p><h1>Masters</h4></p></div>
           <br/>
           <br/>
           <div>
         <div style="margin-left: 15%">
             <p ><a href="Masters?action=listUnitOfMeasure" style="color: white;">Unit Of Measures</a></p>
        </div>
        <div style="margin-left: 15%">
            <p ><a href="Ingredient?action=listIngredient" style="color: white;">Ingredients</a></p>
        </div>
            <div style="margin-left: 15%">
            <p ><a href="Masters?action=listMenu" style="color: white;">Menus</a></p>
        </div>
           <div style="margin-left: 15%">
            <p ><a href="Masters?action=listMenuItem" style="color: white;">Menu Items</a></p>
        </div>
           </div>
        </form>
                  </div>
