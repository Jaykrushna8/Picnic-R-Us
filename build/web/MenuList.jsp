<%-- 
    Document   : MenuList
    Created on : Jun 29, 2014, 12:54:31 AM
    Author     : Pushpraj
--%>
...
<html>
    ...
    <div class="row-bot-bg">
      <div class="main">
        ...
        <br/>
        <br/>
           <p class="addlink"><a href="AddUpdateMenu.jsp?id=0" style="color:black">Add Menu</a></p>
            </div>
               <div style="margin-left: 15%">
        ...
        <tbody style="color: black;">
            <c:forEach items="${Menus}" var="Menu">
                <tr>
                    ...
                    <td><a href="Menu?action=editMenu&id=${Menu.id}" style="color:black">Update</a></td>
                    <td><a href="Menu?action=deleteMenu&id=${Menu.id}" style="color:black">Delete</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
